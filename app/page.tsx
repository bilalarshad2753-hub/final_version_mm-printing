            ...
            <div className="grid gap-10 lg:grid-cols-[0.95fr_0.85fr] items-center">
              <div>
                ...
                <h2 className="mt-3 text-4xl font-semibold text-white sm:text-5xl">
                  Professional finish, honest pricing, dependable delivery.
                </h2>
                <div className="mt-8 grid gap-4">
                  ...
                  <div className="flex items-start gap-4 rounded-[24px] border border-white/10 bg-[#121418]/80 p-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-6 text-[#d5d5d9]">Lahore delivery available for large orders and urgent jobs.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 rounded-[24px] border border-white/10 bg-[#121418]/80 p-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-6 text-[#d5d5d9]">Premium paper, PVC, and art-stock options for every project.</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="rounded-[32px] border border-white/10 bg-[#0f1215]/95 p-8 shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
                <div className="grid gap-4">
                  <div className="rounded-[24px] border border-white/10 bg-[#16181c]/90 p-6">
                    <p className="text-4xl font-black text-[#ffb597]">1,250+</p>
                    <p className="mt-2 text-sm text-[#d5d5d9]">Happy Clients served with fast, friendly service.</p>
                  </div>
                  <div className="rounded-[24px] border border-white/10 bg-[#16181c]/90 p-6">
                    <p className="text-4xl font-black text-[#ffb597]">12 yrs</p>
                    <p className="mt-2 text-sm text-[#d5d5d9]">Printing experience supporting schools, businesses, and events.</p>
                  </div>
                  <div className="rounded-[24px] border border-white/10 bg-[#16181c]/90 p-6">
                    <p className="text-4xl font-black text-[#ffb597]">50k+</p>
                    <p className="mt-2 text-sm text-[#d5d5d9]">Print jobs completed across card, copy, and custom stationery.</p>
                  </div>
                </div>
              </div>
            </div>
